...
valor ingresado está vacio o incorrecto' */
    ...
    valor que tiene asignado, sino cumple con ninguna condición saldrá de esta por medio de (break) y pasara 
    a la siguiente. Si al final ninguna de las condiciones se cumple el valor de dataVar será (default), mostrará 
    un mensaje que diga que ' El valor ingresado no se puede invertir' */
    }else {
        console.log(`****************************************************************************`.blue);
...
/*Se declaran que las funciones que están después del igual tienen propiedades, operaciones, 
condiciones, etc, que se podrán importar al módulo que las requiere invocando la palabras math. y el
